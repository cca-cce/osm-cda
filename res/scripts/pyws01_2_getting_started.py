# -*- coding: utf-8 -*-
"""pyws01-2-getting-started.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12ODzl87s7h5qT910sKJzjrbTOAHB8t5h
...
#with open('res/scripts/pyws01_2_getting_started.py') as f:
#    exec(f.read())
